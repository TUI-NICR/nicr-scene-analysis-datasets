...
> [!IMPORTANT]
> As of Nov 2022, [precomputed normals](https://cs.nyu.edu/~deigen/dnl/normals_gt.tgz) are not publicly available any 
longer. Normal extraction is therefore optional. However, you can still use 
[Wayback Machine](https://web.archive.org/web/20220412033406/https://cs.nyu.edu/~deigen/dnl/normals_gt.tgz) to download 
the required normals_gt.tgz file.
...
1. Download and convert the dataset to the desired format:
    ...
    nicr_sa_prepare_dataset nyuv2 \
        ...
        [--mat-filepath /path/to/nyu_depth_v2_labeled.mat]
    ```

    With arguments:
    - `--mat-filepath`:  
        Path to already downloaded 'nyu_depth_v2_labeled.mat' file.
