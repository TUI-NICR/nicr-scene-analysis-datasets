...
- fix missing `ignore_first_class` forwarding in `semantic_compute_class_weights`
- minor type-hint fixes
- minimum required version for [IRSAFormer](https://github.com/TUI-NICR/IRSAFormer)
